...
import { Search, Download, Calendar, Building, Map } from "lucide-react";

const RoomTimetable: React.FC = () => {
  return (
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold">Room Timetable</h2>
            ...
            <TableRow>
              ...
              <TableCell>
                <div className="space-y-1">
                  ...
                  <div className="text-sm text-gray-500">CS 2024</div>
                </div>
              </TableCell>
              <TableCell>
                <div className="space-y-1">
                  ...
                  <div className="text-sm text-gray-500">CS 2023</div>
                </div>
              </TableCell>
              <TableCell>
                <div className="space-y-1">
      ...
      <div className="flex justify-between items-center">
        <div className="text-sm text-gray-500">
          Showing schedule for Room 101 (Main Building)
        </div>
